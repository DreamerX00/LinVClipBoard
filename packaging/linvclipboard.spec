...
%changelog
* Wed Sep 23 2026 LinVClipBoard Contributors <noreply@linvclipboard.dev> - 3.2.2-1
- Fix Check for Updates, Windows auto-update and GIF search in shipped builds
